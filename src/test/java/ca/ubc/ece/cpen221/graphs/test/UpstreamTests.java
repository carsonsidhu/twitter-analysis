...
import static ca.ubc.ece.cpen221.graphs.one.Algorithms.commonUpstreamVertices;
...
public class UpstreamTests {
    ...
    public void emptyListTest() {
        List<Vertex<Integer>> downstreamList = commonDownstreamVertices(g1, g1.getVertices().get(0), g1.getVertices().get(1));
    ...
    public void sameVertexTest() {
        List<Vertex<String>> downstreamList =
                commonUpstreamVertices(g5, g5.getVertices().get(0), g5.getVertices().get(0));
    }

    @Test
    public void upstreamTest_g1_1() {
        List<Vertex<Integer>> upstreamVertexList = commonUpstreamVertices(g1, g1.getVertices().get(1), g1.getVertices().get(2) );

        List<Vertex<Integer>> expectedList = new ArrayList<>();
        expectedList.add(g1.getVertices().get(0));

        assertEquals(upstreamVertexList, expectedList);
    }

    @Test
    public void upstreamTest_g1_2() {
        List<Vertex<Integer>> upstreamVertexList = commonUpstreamVertices(g1, g1.getVertices().get(3), g1.getVertices().get(4) );

        List<Vertex<Integer>> expectedList = new ArrayList<>();
        expectedList.add(g1.getVertices().get(1));

        assertEquals(upstreamVertexList, expectedList);
    }

    @Test
    public void upstreamTest_g1_3() {
        List<Vertex<Integer>> upstreamVertexList = commonUpstreamVertices(g1, g1.getVertices().get(5), g1.getVertices().get(6) );

        List<Vertex<Integer>> expectedList = new ArrayList<>();
        expectedList.add(g1.getVertices().get(2));

        assertEquals(upstreamVertexList, expectedList);
    }

    @Test
    public void upstreamTest_g4_1() {
        List<Vertex<Integer>> upstreamVertexList = commonUpstreamVertices(g4, g4.getVertices().get(2), g4.getVertices().get(3) );

        List<Vertex<Integer>> expectedList = new ArrayList<>();
        expectedList.add(g4.getVertices().get(1));

        assertEquals(upstreamVertexList, expectedList);
    }

    @Test
    public void upstreamTest_g4_2() {
        List<Vertex<Integer>> upstreamVertexList = commonUpstreamVertices(g4, g4.getVertices().get(2), g4.getVertices().get(1) );

        List<Vertex<Integer>> expectedList = new ArrayList<>();
        expectedList.add(g4.getVertices().get(0));

        assertEquals(upstreamVertexList, expectedList);
    }

    @Test
    public void upstreamTest_g5_1() {
        List<Vertex<String>>
            upstreamVertexList = commonUpstreamVertices(g5, g5.getVertices().get(2), g5.getVertices().get(3) );

        List<Vertex<String>> expectedList = new ArrayList<>();
        expectedList.add(g5.getVertices().get(0));

        assertEquals(upstreamVertexList, expectedList);
    }

    @Test
    public void upstreamTest_g5_2() {
        List<Vertex<String>>
            upstreamVertexList = commonUpstreamVertices(g5, g5.getVertices().get(2), g5.getVertices().get(6) );

        List<Vertex<String>> expectedList = new ArrayList<>();
        expectedList.add(g5.getVertices().get(3));

        assertEquals(upstreamVertexList, expectedList);
    }

    @Test
    public void upstreamTest_g6_1() {
        List<Vertex<String>>
            upstreamVertexList = commonUpstreamVertices(g6, g6.getVertices().get(2), g6.getVertices().get(3) );

        List<Vertex<String>> expectedList = new ArrayList<>();
        expectedList.add(g6.getVertices().get(0));

        assertEquals(upstreamVertexList, expectedList);
    }

    @Test
    public void upstreamTest_g6_2() {
        List<Vertex<String>>
            upstreamVertexList = commonUpstreamVertices(g6, g6.getVertices().get(2), g6.getVertices().get(6) );

        List<Vertex<String>> expectedList = new ArrayList<>();
        expectedList.add(g6.getVertices().get(3));

        assertEquals(upstreamVertexList, expectedList);
    }

    @Test
    public void upstreamTest_g6_3() {
        List<Vertex<String>>
            upstreamVertexList = commonUpstreamVertices(g6, g6.getVertices().get(2), g6.getVertices().get(7) );

        List<Vertex<String>> expectedList = new ArrayList<>();
        expectedList.add(g6.getVertices().get(9));

        assertEquals(upstreamVertexList, expectedList);
    }

    @Test
    public void upstreamTest_g6_4() {
        List<Vertex<String>>
            upstreamVertexList = commonUpstreamVertices(g6, g6.getVertices().get(1), g6.getVertices().get(2) );
